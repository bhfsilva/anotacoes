...
- Para criarmos uma função de computador que computa o valor da raiz quadrada de um número podemos usar o [método de aproximação sucessiva](livros/sicp/capitulo-1/_indice.md#^aprox-suc-method-ref):
